...
BOOST_AUTO_TEST_CASE(find_points_in_non_vertical_or_horizontal_line_segment) {
    LineSegment ls = {Point{0, 8}, Point{8, 0}};
...
BOOST_AUTO_TEST_CASE(add_lines_to_map) {
    ...
    addLinesToMap(std::vector<LineSegment>{ls1, ls2}, map, 6, 6);
